...
- **Once hashes are captured, it should extract from Responder.db using sqllite3 and crack hashes with Hashcat and the potfile with cracked NetNTLMv2 hashes and their plaintext passwords**
